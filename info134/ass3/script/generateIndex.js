...
/**
	* Fills the rating section with a movie and information about the movie.
	*/
...
/**
	* Takes the width of the screen and uses this information to decide how many
	* movies should be shown for each "step" in the lists.
	*/
...
/**
	* Function for clearing the lists so that new information can be shown.
	*/
...
/**
	* 
	* @param {String} id | Id of the list to increase the numbering 
	*/
